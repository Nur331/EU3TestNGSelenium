...
// get text from table
    ...
    Assert.assertTrue(table1.getText().contains("Jason jdoe@hotmail.com"));
...
List<WebElement> headers= driver.findElements(By.xpath("//table[@id='table1']//th"));
    System.out.println("elements.size() = " + headers.size());
...
// if you are looking for exact matching cell(email)
@Test
